      ...
      <div className="w-full flex h-2/3 relative">
        ...
        <div className="w-full flex justify-center items-center">
          <div className="text-center">
            <h1 className="text-xl sm:text-3xl text-amber-900 font-bold">
        ...
        {[
          ...
          return (
            <div key={index} className="mx-4">
              <p className="text-xs sm:text-sm text-amber-900 font-semibold hover:text-amber-600 transition-all duration-300">
